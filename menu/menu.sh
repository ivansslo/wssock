...
data_ip="https://raw.githubusercontent.com/ivansslo/permission/main/ipmini"
checking_sc() {
...
checking_sc
Name=$(curl -sS https://raw.githubusercontent.com/ivansslo/permission/main/ipmini | grep $ipsaya | awk '{print $2}')
# =========================================
...
export sem=$( curl -s https://raw.githubusercontent.com/ivansslo/permission/main/ipmini)
